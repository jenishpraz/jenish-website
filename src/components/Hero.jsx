...
export default function Hero() {
  ...
  return (
    <section id="home" className={`relative min-h-screen flex items-center overflow-hidden ${isDark ? 'bg-dark grid-bg' : 'bg-white'
      }`}>
      {/* Ambient blobs */}
        ...
        <div className="grid lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_460px] gap-8 lg:gap-10 items-center">
          ...
          >
            ...
            >
              ...
              <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-64 h-72 lg:w-72 lg:h-80 rounded-[2.5rem] ${isDark ? 'bg-dark-card' : 'bg-accent-light'
